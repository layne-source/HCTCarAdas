...
**P2 处理优先序**（rev.5）：**可立即处理项已全部完成**（P2-2、P2-4、P2-5、P2-6、P2-7、P2-9、P2-11）。项目内仅剩 **P2-8**（需产品决策）。跨级别的其余待办：
...
| 4 | 标定参数实车标定 | 真实车道帧 | `MIN_ROI_FAR_DISTANCE_METERS`、`MAX_CONVERGENCE_STD_DEV`、提示阈值 5 次 |

> **P2-4 的附带行为变更已确认接受**（测试阶段无老用户，不做迁移；`43161c0` 已把该理由写进代码注释）。原第 4 项因此关闭，待办由 5 项降为 **4 项**。
